<?php
	...
	if (empty($_POST['nombre'])) {
		...
		$saldo=mysqli_real_escape_string($con,(strip_tags($_POST["saldo"],ENT_QUOTES)));

		$documento_cliente=mysqli_real_escape_string($con,(strip_tags($_POST["documento"],ENT_QUOTES)));

		$empresa_cliente=mysqli_real_escape_string($con,(strip_tags($_POST["empresa_cliente"],ENT_QUOTES)));
